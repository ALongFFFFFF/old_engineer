...
//电机编码值规整 0—8191
// int16_t ecd_format(ecd)         
//     {                    
//         int16_t ECD_RANGE=8191;       
//         if (ecd > ECD_RANGE)  
//             ecd -= ECD_RANGE; 
//         else if (ecd < 0)     
//             ecd += ECD_RANGE;
...
// 出爪
    ...
    //控制出抓电机
    //if  (forearm.stretch_lenth <= stretch_out_lenth || forearm.stretch_lenth >= stretch_back_lenth)
    //{
        //forearm.can.stretch_L = (int16_t)forearm_PID_calc(&forearm_PID[2],forearm.can.stretch_speed_L,forearm.can.stretch_target);
            //if (-10 >=forearm.can.stretch_speed_L -forearm.can.stretch_target || forearm.can.stretch_speed_L -forearm.can.stretch_target >=10)
        //{
            forearm.can.stretch_L = (int16_t)forearm_PID_calc(&forearm_PID[2],forearm.can.stretch_speed_L,forearm.can.stretch_target);
            //ecd_format(forearm.can.stretch_L);
            //forearm.can.stretch_R = -forearm.can.stretch_L;
        //}
    ...
    // else
    // {
    //     if (forearm.stretch_lenth >= stretch_out_lenth)
    //     {
    //         forearm.stretch_lenth = stretch_out_lenth;  
    //         forearm.can.stretch_L = 0;
    //         forearm.can.stretch_R = 0;
    //     }
    //     else
    //     {
    //         forearm.stretch_lenth = stretch_back_lenth; 
    //         forearm.can.stretch_L = 0;
    //         forearm.can.stretch_R = 0;
    //     }
    // }
...
void forearm_PID_init(void)
{
    ...
    forearm_PID[4].mode = PID_DELTA;
    forearm_PID[4].Kp = FOREARM_STRETCH_R_KP;
    forearm_PID[4].Ki = FOREARM_STRETCH_R_KI;
